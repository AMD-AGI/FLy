...
from fly import utils
from fly.api.instance import Instance
from fly.api.model import TemplateLM
from fly.api.registry import register_model
from fly.models.utils import (
    Collator,
    clear_torch_cache,
    configure_pad_token,
    get_dtype,
            ...
            if autogptq:
                try:
                    ...
                    raise type(exception)(
                        ...
                        "please install auto-gptq via pip install fly[gptq] or pip install -e .[gptq]",
                    )
            ...
            if gptqmodel:
                try:
                    ...
                    raise type(exception)(
                        ...
                        "please install gptqmodel via `pip install gptqmodel --no-build-isolation` or `pip install fly[gptqmodel] --no-build-isolation`",
                    )
