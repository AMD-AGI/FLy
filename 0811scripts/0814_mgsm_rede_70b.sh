...
do
    python -m lm_eval \
        ...
        &> ./output_log/${data}_2_rede_70B_${task}_UseReDe${use_rede}_Usengram${use_ngram}_ngramSize${max_ngram_size}_ngramPredict${num_ngram_pred_tokens}_winL${win_len}_thre${thre}
done
done
