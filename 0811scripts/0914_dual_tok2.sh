...
dsr1_qwen_7b="deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
mistral_large="mistralai/Mistral-Large-Instruct-2411"
qwen25_coder_15b="Qwen/Qwen2.5-Coder-1.5B-Instruct"
mistral_8b="mistralai/Ministral-8B-Instruct-2410"

draft_model=${dsr1_qwen_15b}
target_model=${dsr1_llama70b}
...
data=0914
model_name=FLy_dsr1_qwen_15b_dsr1_llama70b
