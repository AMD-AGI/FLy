...
python -m lm_eval \
    --model hf \
    --model_args pretrained=${draft_model},parallelize=${para},config_path=${config_path},tree_verify=True \
    --tasks ${task} \
    --output_path ./eval_out/${data}_${task}_tree_verify \
    --show_config \
    --log_samples \
    --batch_size 1 \
    --apply_chat_template \
    ...
    &> ./output_log/${data}_${task}_FLy_Llama3_70b_tree_verify.log
