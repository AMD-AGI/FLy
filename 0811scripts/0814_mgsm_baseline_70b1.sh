...
for task in mgsm_native_cot_fr_0813 mgsm_native_cot_ja_0813
do
    python -m lm_eval \
        --model hf \
...
# mgsm_native_cot_zh_0813 mgsm_native_cot_de_0813 mgsm_native_cot_en_0813 mgsm_native_cot_es_0813 mgsm_native_cot_fr_0813 mgsm_native_cot_ja_0813
