...
for task in mgsm_native_cot_te_0813 mgsm_native_cot_th_0813 mgsm_native_cot_bn_0813
do
    python -m lm_eval \
        --model hf \
        ...
        &> ./output_log/${data}_1_baseline70B_${task}
done
...
# mgsm_native_cot_ru_0813 mgsm_native_cot_sw_0813 mgsm_native_cot_te_0813 mgsm_native_cot_th_0813 mgsm_native_cot_bn_0813
