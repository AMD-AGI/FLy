...
target_model_list=(llama31_405B)
...
do
    ...
    python -m lm_eval \
        --model hf \
        --model_args pretrained=${draft_model},parallelize=True,target_model_path=${t_model_path},use_sd=True,spd_k=0 \
        --tasks ${task} \
        ...
        &> ./output_log/0811_2_gpunum4_HF_${task}_${target_model}
done
done
