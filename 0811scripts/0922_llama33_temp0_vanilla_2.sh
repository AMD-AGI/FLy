...
for task in mgsm_native_cot_fr_0813 mgsm_native_cot_de_0813 mgsm_native_cot_th_0813 mbpp_plus_instruct niah_multivalue 
...
do
    python -m lm_eval \
        ...
        &> ./output_log/${data}_llama33_${task}_temp${temp}_vanilla
done
