...
ml3_70b="meta-llama/Meta-Llama-3-70B-Instruct"
ml3_8b="meta-llama/Meta-Llama-3-8B-Instruct"

draft_model=${ml3_8b}
target_model=${ml3_70b}
...
for task in mbpp_plus_instruct gsm8k_cot_llama humaneval_instruct
do
for trial in 2 3
do
    python -m lm_eval \
        ...
        &> ./output_log/${data}_ml3_8b70b_${task}_temp${temp}_trial${trial}
done
done
